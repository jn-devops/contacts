...
class GetContactMetadataFromContactModel
{
    ...
    public function handle(Contact $model): ContactMetaData
    {
        return new ContactMetaData(
            ...
            civil_status: $model->civil_status ? CivilStatus::from($model->civil_status) : null ,
            sex: $model->sex ? Sex::from($model->sex) : null,
            nationality: $model->nationality ? Nationality::from($model->nationality) : null,
