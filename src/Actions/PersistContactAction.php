...
class PersistContactAction
{
    ...
    public function rules(): array
    {
        return [
            ...
            'order.amort_mrisri2' => ['nullable', 'numeric'],
            'order.amort_mrisri3' => ['nullable', 'numeric'],
            'order.amort_nonlife1' => ['nullable', 'numeric '],
            'order.amort_nonlife2' => ['nullable', 'numeric'],
            'order.amort_nonlife3' => ['nullable', 'numeric'],
            'order.amort_princ_int1' => ['nullable', 'numeric'],
            'order.amort_princ_int2' => ['nullable', 'numeric'],
            'order.amort_princ_int3' => ['nullable', 'numeric'],
