...
class PersistContactAction
{
    ...
    public function rules(): array
    {
        return [
            ...
            'order.property_name' => ['nullable', 'string'],
            'order.phase' => ['nullable', 'string'],
            'order.block' => ['nullable', 'string'],
            'order.lot' => ['nullable', 'string'],
            'order.lot_area' => ['nullable', 'string'],
            'order.floor_area' => ['nullable', 'string'],
            'order.tcp' => ['nullable', 'string'],
            'order.loan_term' => ['nullable', 'string'],
            'order.loan_interest_rate' => ['nullable', 'string'],
            'order.tct_no' => ['nullable', 'string'],

            'order.project_location' => ['nullable', 'string'],
            'order.project_address' => ['nullable', 'string'],
            'order.mrif_fee' => ['nullable', 'string'],
            'order.reservation_rate' => ['nullable', 'string'],

            'order.class_field' => ['nullable', 'string'],
            'order.segment_field' => ['nullable', 'string'],
            'order.rebooked_id_form' => ['nullable', 'numeric'],
            'order.buyer_action_form_number' => ['nullable', 'string'],
            ...
            'order.payment_scheme.collectible_price' => ['nullable', 'string'],
            'order.payment_scheme.commissionable_amount' => ['nullable', 'string'],
            'order.payment_scheme.evat_percentage' => ['nullable', 'string'],
            'order.payment_scheme.net_total_contract_price' => ['nullable', 'string'],
            'order.payment_scheme.total_contract_price' => ['nullable', 'string'],
            'order.payment_scheme.*.payment' => ['nullable', 'array'],

            'order.payment_scheme.payment.*.type' => ['nullable', 'array'],
            'order.payment_scheme.payment.*.amount_paid' => ['nullable', 'string'],
            ...
            'order.payment_scheme.fees.*.amount' => ['nullable', 'string'],

            'order.payment_scheme.payment_remarks' => ['nullable', 'string'],
            'order.payment_scheme.transaction_remarks' => ['nullable', 'string'],
            'order.payment_scheme.discount_rate' => ['nullable', 'string'],
            'order.payment_scheme.conditional_discount' => ['nullable', 'string'],
