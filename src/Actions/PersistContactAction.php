...
class PersistContactAction
{
    ...
    public function rules(): array
    {
        return [
            ...
            'order.seller.rate' => ['nullable'],
            'order.seller.rate_amount' => ['nullable'],
            ...
            'order.aif.client_id' => ['nullable'],
            'order.aif.account_name' => ['nullable', 'string'],
            'order.aif.username_or_email' => ['nullable', 'string'],
            'order.aif.profile' => ['nullable', 'array'],
            'order.aif.profile.first_name' => ['nullable'],
            'order.aif.profile.middle_name' => ['nullable'],
            'order.aif.profile.last_name' => ['nullable'],
            'order.aif.profile.name_suffix' => ['nullable'],
            'order.aif.profile.civil_status' => ['nullable'],
            'order.aif.profile.sex' => ['nullable'],
            'order.aif.profile.nationality' => ['nullable'],
            'order.aif.profile.date_of_birth' => ['nullable', 'date'],
            'order.aif.profile.email' => ['nullable'],
            'order.aif.profile.mobile' => ['nullable'],
            'order.aif.profile.other_mobile' => ['nullable'],
            'order.aif.profile.help_number' => ['nullable'],
            'order.aif.profile.landline' => ['nullable'],
            'order.aif.profile.mothers_maiden_name' => ['nullable'],
            'order.aif.profile.age' => ['nullable'],
            'order.aif.profile.relationship_to_buyer' => ['nullable'],
            'order.aif.profile.passport' => ['nullable'],
            'order.aif.profile.date_issued' => ['nullable'],
            'order.aif.profile.place_issued' => ['nullable'],

            'co_borrowers' => ['nullable', 'array'],
            'co_borrowers.*.id' => ['nullable'],
            'co_borrowers.*.tin' => ['nullable'],
            'co_borrowers.*.spouse_tin' => ['nullable'],

            'co_borrowers.*.profile' => ['nullable', 'array'],
            'co_borrowers.*.profile.first_name' => ['nullable'],
            'co_borrowers.*.profile.middle_name' => ['nullable'],
            'co_borrowers.*.profile.last_name' => ['nullable'],
            'co_borrowers.*.profile.name_suffix' => ['nullable'],
            'co_borrowers.*.profile.civil_status' => ['nullable'],
            'co_borrowers.*.profile.sex' => ['nullable'],
            'co_borrowers.*.profile.nationality' => ['nullable'],
            'co_borrowers.*.profile.date_of_birth' => ['nullable', 'date'],
            'co_borrowers.*.profile.email' => ['nullable'],
            'co_borrowers.*.profile.mobile' => ['nullable'],
            'co_borrowers.*.profile.other_mobile' => ['nullable'],
            'co_borrowers.*.profile.help_number' => ['nullable'],
            'co_borrowers.*.profile.landline' => ['nullable'],
            'co_borrowers.*.profile.mothers_maiden_name' => ['nullable'],
            'co_borrowers.*.profile.age' => ['nullable'],
            'co_borrowers.*.profile.relationship_to_buyer' => ['nullable'],
            'co_borrowers.*.profile.passport' => ['nullable'],
            'co_borrowers.*.profile.date_issued' => ['nullable'],
            'co_borrowers.*.profile.place_issued' => ['nullable'],

            'co_borrowers.*.spouse' => ['nullable', 'array'],
            'co_borrowers.*.spouse.first_name' => ['nullable'],
            'co_borrowers.*.spouse.middle_name' => ['nullable'],
            'co_borrowers.*.spouse.last_name' => ['nullable'],
            'co_borrowers.*.spouse.name_suffix' => ['nullable'],
            'co_borrowers.*.spouse.civil_status' => ['nullable'],
            'co_borrowers.*.spouse.sex' => ['nullable'],
            'co_borrowers.*.spouse.nationality' => ['nullable'],
            'co_borrowers.*.spouse.date_of_birth' => ['nullable', 'date'],
            'co_borrowers.*.spouse.email' => ['nullable'],
            'co_borrowers.*.spouse.mobile' => ['nullable'],
            'co_borrowers.*.spouse.other_mobile' => ['nullable'],
            'co_borrowers.*.spouse.help_number' => ['nullable'],
            'co_borrowers.*.spouse.landline' => ['nullable'],
            'co_borrowers.*.spouse.mothers_maiden_name' => ['nullable'],
            'co_borrowers.*.spouse.age' => ['nullable'],
            'co_borrowers.*.spouse.relationship_to_buyer' => ['nullable'],
            'co_borrowers.*.spouse.passport' => ['nullable'],
            'co_borrowers.*.spouse.date_issued' => ['nullable'],
            'co_borrowers.*.spouse.place_issued' => ['nullable'],
        ];
    }
