...
class PersistContactAction
{
    ...
    public function rules(): array
    {
        return [
            ...
            'order.equity_2_amount' => ['nullable', 'numeric'],
            'order.equity_2_percentage_rate' => ['nullable', 'numeric'],
            'order.equity_2_interest_rate' => ['nullable', 'numeric'],
            'order.equity_2_terms' => ['nullable', 'numeric'],
            ...
            'order.aif.name' => ['nullable', 'string'],
            'order.aif.address' => ['nullable', 'string'],
            'order.aif.last_name' => ['nullable', 'string'],
            'order.aif.first_name' => ['nullable', 'string'],
            'order.aif.middle_name' => ['nullable', 'string'],
            'order.aif.extension_name' => ['nullable', 'string'],
            'order.aif.lot_unit' => ['nullable'],
            'order.aif.street' => ['nullable', 'string'],
            'order.aif.subdivision' => ['nullable', 'string'],
            'order.aif.barangay' => ['nullable', 'string'],
            'order.aif.city' => ['nullable', 'string'],
            'order.aif.province' => ['nullable', 'string'],
            'order.aif.zip_code' => ['nullable'],
            'order.aif.length_of_stay' => ['nullable', 'string'],
            'order.aif.ownership_type' => ['nullable', 'string'],
            'order.aif.birthday' => ['nullable', 'date'],
            'order.aif.age' => ['nullable'],
            'order.aif.gender' => ['nullable', 'string'],
            'order.aif.civil_status' => ['nullable', 'string'],
            'order.aif.nationality' => ['nullable'],
            'order.aif.residence_landline' => ['nullable', 'string'],
            'order.aif.primary_contact_number' => ['nullable'],
            'order.aif.email' => ['nullable', 'string'],
            'order.aif.relationship_to_buyer' => ['nullable', 'string'],
            'order.aif.account_name' => ['nullable', 'string'],
            'order.aif.username_or_email' => ['nullable', 'string'],
            'order.aif.tin' => ['nullable'],
            'order.aif.sss' => ['nullable'],
            'order.aif.pagibig' => ['nullable'],
            'order.aif.passport' => ['nullable'],
            'order.aif.date_issued' => ['nullable', 'date'],
            'order.aif.place_issued' => ['nullable', 'string'],
            'order.aif.employer_name' => ['nullable'],
            'order.aif.employer_address' => ['nullable'],
            'order.aif.employer_type' => ['nullable', 'string'],
            'order.aif.employment_status' => ['nullable'],
            'order.aif.position' => ['nullable', 'string'],
            'order.aif.industry' => ['nullable', 'string'],
            'order.aif.salary_gross_income' => ['nullable'],
            'order.aif.company_phone_number' => ['nullable'],
            'order.aif.fax' => ['nullable', 'string'],
            'order.aif.company_email' => ['nullable', 'string'],
