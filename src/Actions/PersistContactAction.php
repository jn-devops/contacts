...
class PersistContactAction
{
    ...
    public function rules(): array
    {
        return [
            ...
            'order.aif.name_suffix' => ['nullable', 'string'],
            'order.aif.mothers_maiden_name' => ['nullable', 'string'],
            'order.aif.civil_status' => ['nullable', 'string'],
            'order.aif.sex' => ['nullable', 'string'],
            'order.aif.nationality' => ['nullable', 'string'],
            'order.aif.date_of_birth' => ['nullable'],
            'order.aif.email' => ['nullable', 'string'],
            'order.aif.mobile' => ['nullable', 'string'],
