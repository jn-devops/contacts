...
class ContactOrderData extends Data
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'disclosure_statement_on_loan_transaction_total' => $this->disclosure_statement_on_loan_transaction_total,
            'documentary_stamp' => $this->documentary_stamp,
            'total_deductions_from_loan_proceeds' => $this->total_deductions_from_loan_proceeds,
            'net_loan_proceeds' => $this->net_loan_proceeds,
