...
class ContactOrderData extends Data
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'cancellation_reason2' => $this->cancellation_reason2,
            ...
            'equity_2_amount' => $this->equity_2_amount,
            'equity_2_percentage_rate' => $this->equity_2_percentage_rate,
            'equity_2_interest_rate' => $this->equity_2_interest_rate,
            'equity_2_terms' => $this->equity_2_terms,
            'cash_outlay_1_terms' => $this->cash_outlay_1_terms,
            'cash_outlay_1_monthly_payment' => $this->cash_outlay_1_monthly_payment,
            'cash_outlay_1_effective_date' => $this->cash_outlay_1_effective_date,
            'cash_outlay_2_amount' => $this->cash_outlay_2_amount,
            'cash_outlay_2_percentage_rate' => $this->cash_outlay_2_percentage_rate,
            'cash_outlay_2_interest_rate' => $this->cash_outlay_2_interest_rate,
            'cash_outlay_2_terms' => $this->cash_outlay_2_terms,
            'cash_outlay_2_monthly_payment' => $this->cash_outlay_2_monthly_payment,
            'cash_outlay_2_effective_date' => $this->cash_outlay_2_effective_date,
            'cash_outlay_3_amount' => $this->cash_outlay_3_amount,
            'cash_outlay_3_percentage_rate' => $this->cash_outlay_3_percentage_rate,
            'cash_outlay_3_interest_rate' => $this->cash_outlay_3_interest_rate,
            'cash_outlay_3_terms' => $this->cash_outlay_3_terms,
            'cash_outlay_3_monthly_payment' => $this->cash_outlay_3_monthly_payment,
            'cash_outlay_3_effective_date' => $this->cash_outlay_3_effective_date,
            ...
            'buyer_extension_name' => $this->buyer_extension_name,
            'company_acronym' => $this->company_acronym,
            'repricing_period_in_words' => $this->repricing_period_in_words,
            'repricing_period' => $this->repricing_period,
            'company_address' => $this->company_address,
            'exec_position' => $this->exec_position,
            'board_resolution_date' => $this->board_resolution_date,
            'registry_of_deeds_address' => $this->registry_of_deeds_address,
            'exec_tin' => $this->exec_tin,
            'loan_period_in_words' => $this->loan_period_in_words,
            'spouse_address' => $this->spouse_address,
            'total_miscellaneous_fee_in_words' => $this->total_miscellaneous_fee_in_words,
            'tmf' => $this->tmf,
            'cash_outlay_1_amount' => $this->cash_outlay_1_amount,
            'cash_outlay_1_percentage_rate' => $this->cash_outlay_1_percentage_rate,
            'cash_outlay_1_interest_rate' => $this->cash_outlay_1_interest_rate,
            'equity_2_monthly_payment' => $this->equity_2_monthly_payment,
            'equity_2_effective_date' => $this->equity_2_effective_date,
            ...
            'bp_2_amount' => $this->bp_2_amount,
            'bp_2_percentage_rate' => $this->bp_2_percentage_rate,
            'bp_2_interest_rate' => $this->bp_2_interest_rate,
            'bp_2_terms' => $this->bp_2_terms,
            'bp_2_monthly_payment' => $this->bp_2_monthly_payment,
            'bp_2_effective_date' => $this->bp_2_effective_date,
            'hucf_move_in_fee' => $this->hucf_move_in_fee,
            'circular_no_312_379' => $this->circular_no_312_379,
            'ltvr_slug' => $this->ltvr_slug,
            'repricing_period_slug' => $this->repricing_period_slug,
            'tcp_in_words' => $this->tcp_in_words,
            'interest_in_words' => $this->interest_in_words,
            'interest' => $this->interest,
            'logo' => $this->logo,
            'loan_period_months' => $this->loan_period_months,
            'page' => $this->page,
            'lot_area_in_words' => $this->lot_area_in_words,
            'exec_signatories' => $this->exec_signatories,
            'exec_tin_no' => $this->exec_tin_no,
            'loan_terms_in_word' => $this->loan_terms_in_word,
            'company_tin' => $this->company_tin,
            'yes_for_faq_solaris_project' => $this->yes_for_faq_solaris_project,
            'n_for_faq_solaris_project' => $this->n_for_faq_solaris_project,
...
class SellerData extends Data
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'unit' => $this->unit,
            'rate' => $this->rate ?? '',
            'rate_amount' => $this->rate_amount ?? 0,
        ];
    }
}
