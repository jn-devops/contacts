...
class FlatData extends \Spatie\LaravelData\Data
{
    ...
    public static function fromModel(Contact $model): self
    {
        ...
        return new self(
            ...
            aif_middle_name: $data->co_borrower['middle_name'] ?? '',
            aif_extension_name: $data->co_borrower['name_suffix'] ?? '',
            ...
            aif_birthday: $data->co_borrower['date_of_birth'] ?? '',
            aif_age: $data->co_borrower['age'] ?? '',
            aif_gender: $data->co_borrower['sex'] ?? '',
            aif_civil_status: $data->co_borrower['civil_status'] ?? '',
            aif_nationality: $data->co_borrower['nationality'] ?? '',
            aif_residence_landline: $data->co_borrower['landline'] ?? '',
