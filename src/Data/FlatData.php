...
class FlatData extends \Spatie\LaravelData\Data
{
    ...
    public static function fromModel(Contact $model): self
    {
        ...
        return new self(
            ...
            aif_name: strtoupper($data->order->aif->name ?? ''),
            aif_last_name: strtoupper($data->order->aif->last_name ?? ''),
            aif_first_name: strtoupper($data->order->aif->first_name ?? ''),
            aif_middle_name: strtoupper($data->order->aif->middle_name ?? ''),
            aif_extension_name: strtoupper($data->order->aif->extension_name ?? ''),
            aif_unit_lot: $data->order->aif->unit_lot ?? '',
            aif_street: $data->order->aif->street ?? '',
            aif_subdivision: $data->order->aif->subdivision ?? '',
            aif_barangay: $data->order->aif->barangay ?? '',
            aif_city: $data->order->aif->city ?? '',
            aif_province: $data->order->aif->province ?? '',
            aif_zip_code: $data->order->aif->zip_code ?? '',
            aif_length_of_stay: $data->order->aif->length_of_stay ?? '',
            aif_ownership_type: $data->order->aif->ownership_type ?? '',
            aif_birthday: $data->order->aif->birthday ?? '',
            aif_age: $data->order->aif->age ?? '',
            aif_gender: $data->order->aif->gender ?? '',
            ...
            aif_residence_landline: $data->order->aif->residence_landline ?? '',
            aif_primary_contact_number: $data->order->aif->primary_contact_number ?? '',
            aif_email: $data->order->aif->email ?? '',
            aif_relationship_to_buyer: $data->order->aif->relationship_to_buyer ?? '',
            aif_account_name: strtoupper(($data->order->aif->first_name ?? '').($data->order->aif->middle_name ?? '').($data->order->aif->last_name ?? '')),
            aif_username_or_email: $data->order->aif->username_or_email ?? '',
            aif_sss: $data->order->aif->sss ?? '',
            aif_pagibig: $data->order->aif->pagibig ?? '',
            aif_tin: $data->order->aif->tin ?? '',
            aif_passport: $data->order->aif->passport ?? '',
            aif_date_issued: $data->order->aif->date_issued ?? '',
            aif_place_issued: $data->order->aif->place_issued ?? '',
            aif_employer_name: strtoupper($data->order->aif->employer_name ?? ''),
            aif_employer_address: $data->order->aif->employer_address ?? '',
            aif_employer_type: $data->order->aif->employer_type ?? '',
            aif_employment_status: $data->order->aif->employment_status ?? '',
            aif_position: $data->order->aif->position ?? '',
            aif_industry: $data->order->aif->industry ?? '',
            aif_salary_gross_income: $data->order->aif->salary_gross_income ?? '',
            aif_company_phone_number: $data->order->aif->company_phone_number ?? '',
            aif_fax: $data->order->aif->fax ?? '',
            aif_company_email: $data->order->aif->company_email ?? '',
