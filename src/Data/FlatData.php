...
class FlatData extends \Spatie\LaravelData\Data
{
    ...
    public static function fromModel(Contact $model): self
    {
        ...
        return new self(
            ...
            tcp: $data->order->tcp ?? '',
            tcp_in_words: isset($data->order->payment_scheme->total_contact_price) ? $numberToWords->getNumberTransformer('en')->toWords($data->order->payment_scheme->total_contact_price) : '',
            ...
            aif_name: $data->co_borrowers[0]->aif_name ?? '',
            co_borrower_name: ($data->co_borrowers[0]->first_name ?? '').($data->co_borrowers[0]->middle_name ?? '').($data->co_borrowers[0]->last_name ?? ''),
            ...
            aif_last_name: $data->co_borrowers[0]->last_name ?? '',
            aif_first_name: $data->co_borrowers[0]->first_name ?? '',
            aif_middle_name: $data->co_borrowers[0]->middle_name ?? '',
            aif_extension_name: $data->co_borrowers[0]->name_suffix ?? '',
            ...
            aif_birthday: $data->co_borrowers[0]->date_of_birth ?? '',
            ...
            aif_email: $data->co_borrowers[0]->email ?? '',
            aif_relationship_to_buyer: $data->co_borrowers[0]->relationship_to_buyer ?? '',
            aif_account_name: ($data->co_borrowers[0]->first_name ?? '').($data->co_borrowers[0]->middle_name ?? '').($data->co_borrowers[0]->last_name ?? ''),
            ...
            aif_employer_name: $data->employment?->toCollection()->firstWhere('type', 'co_borrower')->employer->name ?? '',
            ...
            buyer_employer_name: $data->employment?->toCollection()->firstWhere('type', 'buyer')->employer->name ?? '',
            ...
            buyer_salary_gross_income: $data->employment?->toCollection()->firstWhere('type', 'buyer')->monthly_gross_income ?? '',
            ...
            cash_outlay_1_amount: $data->order->cash_outlay_1_amount ?? '',
            cash_outlay_1_percentage_rate: $data->order->cash_outlay_1_percentage_rate ?? '',
            cash_outlay_1_interest_rate: $data->order->cash_outlay_1_interest_rate ?? '',
            cash_outlay_1_terms: $data->order->cash_outlay_1_terms ?? '',
            cash_outlay_1_monthly_payment: $data->order->cash_outlay_1_monthly_payment ?? '',
            cash_outlay_1_effective_date: $data->order->cash_outlay_1_effective_date ?? '',
            cash_outlay_2_amount: $data->order->cash_outlay_2_amount ?? '',
            cash_outlay_2_percentage_rate: $data->order->cash_outlay_2_percentage_rate ?? '',
            cash_outlay_2_interest_rate: $data->order->cash_outlay_2_interest_rate ?? '',
            cash_outlay_2_terms: $data->order->cash_outlay_2_terms ?? '',
            cash_outlay_2_monthly_payment: $data->order->cash_outlay_2_monthly_payment ?? '',
            ...
            cash_outlay_3_monthly_payment: $data->order->cash_outlay_3_monthly_payment ?? '',
            cash_outlay_3_effective_date: $data->order->cash_outlay_3_effective_date ?? '',
            equity_1_amount: $data->order->equity_1_amount ?? '',
            ...
            equity_1_monthly_payment: $data->order->equity_1_monthly_payment ?? '',
            equity_1_effective_date: $data->order->equity_1_effective_date ?? '',
            equity_2_amount: $data->order->equity_2_amount ?? '',
            ...
            equity_2_monthly_payment: $data->order->equity_2_monthly_payment ?? '',
            equity_2_effective_date: $data->order->equity_2_effective_date ?? '',
            bp_1_amount: $data->order->bp_1_amount ?? '',
            ...
            bp_1_monthly_payment: $data->order->bp_1_monthly_payment ?? '',
            ...
            bp_2_monthly_payment: $data->order->bp_2_monthly_payment ?? '',
