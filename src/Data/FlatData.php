...
class FlatData extends \Spatie\LaravelData\Data
{
    ...
    public static function fromModel(Contact $model): self
    {
        ...
        return new self(
            ...
            pf_amount_paid: $data->order->payment_scheme->payments[0]->amount_paid,
            pf_payment_reference_number: $data->order->payment_scheme->payments[0]->reference_number,
            pf_payment_date: $data->order->payment_scheme->payments[0]->date,
            hucf_amount_paid: $data->order->payment_scheme->payments[0]->amount_paid,
            hucf_payment_reference_number: $data->order->payment_scheme->payments[0]->reference_number,
            hucf_payment_date: $data->order->payment_scheme->payments[0]->date,
            balance_payment_amount_paid: $data->order->payment_scheme->payments[0]->amount_paid,
            balance_payment_reference_number: $data->order->payment_scheme->payments[0]->reference_number,
            balance_payment_date: $data->order->payment_scheme->payments[0]->date,
