...
class FlatData extends \Spatie\LaravelData\Data
{
    ...
    public static function fromModel(Contact $model): self
    {
        try {
            ...
            buyer_civil_status_to_lower_case: ($data->profile->civil_status) ? ((strtoupper($data->profile->civil_status) == 'MARRIED') ? strtolower($data->profile->civil_status.' to ')  : 'single/married') : '',
            ...
            pagibig_filing_site: '11F JELP Business Solution Center, #409 Shaw Boulevard, Mandaluyong City, Trunk line: (02) 422-3000',
            );
