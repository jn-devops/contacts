...
class FlatData extends \Spatie\LaravelData\Data
{
    ...
    public static function fromModel(Contact $model): self
    {
        ...
        return new self(
            ...
            spouse_tin_with_label: $data->employment?->toCollection()->firstWhere('type', 'spouse')->id?->tin ==null?'':'TIN: '.$data->employment?->toCollection()->firstWhere('type', 'spouse')->id->tin,
            ...
            loan_term_in_years_in_words : strtoupper(self::convertNumberToWords(($data->order->loan_term ?? 0) / 12)),
