...
class FlatData extends \Spatie\LaravelData\Data
{
    ...
    public static function fromModel(Contact $model): self
    {
        ...
        return new self(
            ...
            aif_name: strtoupper("{$data->order->aif->first_name} {$data->order->aif->middle_name} {$data->order->aif->last_name} {$data->order->aif->name_suffix}" ),
            ...
            aif_extension_name: $data->order->aif->name_suffix ?? '',
            aif_mobile: $data->order->aif->mobile ?? '',
            aif_other_mobile: $data->order->aif->other_mobile ?? '',
            aif_landline: $data->order->aif->landline ?? '',
