...
//    dd($flatData->buyer_civil_status_lower_case,$flatData->spouse_civil_status_lower_case,$flatData->co_borrower_civil_status_lower_case,$flatData->aif_civil_status_lower_case );
